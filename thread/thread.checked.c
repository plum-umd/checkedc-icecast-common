...
/* misc thread stuff */
static void *_start_routine(void *arg) : itype(_Ptr<void> ) ;
...
thread_type * thread_create_c(_Nt_array_ptr<char> name, _Ptr<void* (void* )> start_routine, void* arg, int detached, int line, _Nt_array_ptr<char> file)
{
...
void thread_rename(_Nt_array_ptr<const char> name)
{
    thread_type *th;
